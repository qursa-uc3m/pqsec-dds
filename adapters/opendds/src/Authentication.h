...
public:
  ...
  validate_local_identity(DDS::Security::IdentityHandle&, OpenDDS::DCPS::GUID_t&,
                          DDS::Security::DomainId_t, const DDS::DomainParticipantQos&,
                          const OpenDDS::DCPS::GUID_t&, DDS::Security::SecurityException&);
  CORBA::Boolean get_identity_token(DDS::Security::IdentityToken&, DDS::Security::IdentityHandle,
  ...
  CORBA::Boolean get_identity_status_token(DDS::Security::IdentityStatusToken&,
                                           ...
                                           DDS::Security::SecurityException&);
  CORBA::Boolean set_permissions_credential_and_token(
      DDS::Security::IdentityHandle, const DDS::Security::PermissionsCredentialToken&,
      const DDS::Security::PermissionsToken&, DDS::Security::SecurityException&);
  DDS::Security::ValidationResult_t
  validate_remote_identity(DDS::Security::IdentityHandle&, DDS::Security::AuthRequestMessageToken&,
                           const DDS::Security::AuthRequestMessageToken&,
                           DDS::Security::IdentityHandle, const DDS::Security::IdentityToken&,
                           const OpenDDS::DCPS::GUID_t&, DDS::Security::SecurityException&);
  DDS::Security::ValidationResult_t
  begin_handshake_request(DDS::Security::HandshakeHandle&, DDS::Security::HandshakeMessageToken&,
                          DDS::Security::IdentityHandle, DDS::Security::IdentityHandle,
                          const DDS::OctetSeq&, DDS::Security::SecurityException&);
  DDS::Security::ValidationResult_t
  begin_handshake_reply(DDS::Security::HandshakeHandle&, DDS::Security::HandshakeMessageToken&,
                        DDS::Security::IdentityHandle, DDS::Security::IdentityHandle,
                        const DDS::OctetSeq&, DDS::Security::SecurityException&);
  DDS::Security::ValidationResult_t process_handshake(DDS::Security::HandshakeMessageToken&,
                                                      const DDS::Security::HandshakeMessageToken&,
                                                      DDS::Security::HandshakeHandle,
                                                      DDS::Security::SecurityException&);
  DDS::Security::SharedSecretHandle* get_shared_secret(DDS::Security::HandshakeHandle,
                                                       DDS::Security::SecurityException&);
  CORBA::Boolean
  get_authenticated_peer_credential_token(DDS::Security::AuthenticatedPeerCredentialToken&,
                                          DDS::Security::HandshakeHandle,
                                          DDS::Security::SecurityException&);
  ...
  CORBA::Boolean return_identity_status_token(const DDS::Security::IdentityStatusToken&,
                                              DDS::Security::SecurityException&);
  CORBA::Boolean
  return_authenticated_peer_credential_token(const DDS::Security::AuthenticatedPeerCredentialToken&,
                                             DDS::Security::SecurityException&);
...
private:
  ...
  bool validate_remote_credentials(Handshake&, const DDS::Security::Token&, DDS::OctetSeq&,
                                   DDS::Security::SecurityException&);

  // Declared first so the provider remains loaded until all EVP keys are gone.
  ProviderFallback fallback_provider_;
